                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <?php if (!empty($errors['title'])): ?>
                                <small class="text-danger"><?= implode(', ', $errors['title']); ?></small>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-3">
                                <img id="mediaPreview" class="img-thumbnail <?= !empty($old['media_path']) ? '' : 'd-none' ?>"
                                     src="<?= !empty($old['media_path']) ? '/'.$old['media_path'] : '' ?>"
                    ...
                    <?php foreach ($media as $item): ?>
                        <?php if ($item['type'] === 'image' && $item['is_deleted'] == 0): ?>
                            <div class="col-md-3 mb-3">
                                <div class="card media-item" style="cursor:pointer"
                                     data-id="<?= $item['id'] ?>"
                                     data-path="/<?= htmlspecialchars($item['path']) ?>">
                                    <img src="/<?= htmlspecialchars($item['path']) ?>" class="card-img-top"
