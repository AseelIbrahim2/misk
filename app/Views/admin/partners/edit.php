        ...
        <div class="container-fluid">
            ...
            <div class="card card-outline card-success">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-edit"></i> Edit Partner</h3>
                </div>

                <form action="/partners/update/<?= $partner['id'] ?>" method="POST">
                    <input type="hidden" name="csrf_token" value="<?= \App\Middleware\CsrfMiddleware::generateToken() ?>">
                    <input type="hidden" name="media_id" id="media_id" value="<?= $partner['media_id'] ?>">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mt-2">
                                <img id="mediaPreview" src="<?= !empty($partner['media_path']) ? '/'.$partner['media_path'] : '' ?>"
                                     class="img-thumbnail <?= !empty($partner['media_path']) ? '' : 'd-none' ?>"
